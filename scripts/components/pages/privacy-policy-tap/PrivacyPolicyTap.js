...
export const PrivacyPolicyTap = () => (
  <div className={styles.container}>
    ...
    <p>
      {" "}
      Igor Golopolosov built the Tap, 1.000.000 times! app as a Free app. This
      SERVICE is provided by Igor Golopolosov at no cost and is intended for use
      as is.
    </p>
    <p>
    ...
    <p>
      ...
      Terms and Conditions, which is accessible at Tap, Tap! unless otherwise
    ...
    <p>
      ...
      not limited to CAMERA, RECORD AUDIO, READ PHONE STATE, READ CONTACTS. The
