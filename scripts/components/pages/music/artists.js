...
const Palekh = [
  ...
  },
  {
    ...
    info: `
      ...
      vk.com/iz__p
      vk.com/htkmsc
      soundcloud.com/hotkeymusic/sets/izp-to-burn-and-hope
      yadi.sk/d/AMROkbydmcaJZ
      yadi.sk/d/-Jm6YKAUmqx5T
    `
  },
  {
    band: "сиг?",
    ...
    soundloudPlaylistId: "260868019",
    coverUrl: "https://i1.sndcdn.com/artworks-000186691930-8flxpa-t500x500.jpg",
    tracks: ["обогнавшие скорость!"],
    tags: ["Country", "Palekh", "sig"],
    info: `
      в далёком-далёком прошлом ­саша и ­гоша решили написать песню.
      трудились весь вечер и самое удивительное - это у них получилось!
...
const Ivanovo = [
  ...
  },
  {
    ...
    link:
      "https://soundcloud.com/hotkeymusic/sets/nothing-personal-nothing-wasted",
    soundloudPlaylistId: "264803944",
    coverUrl: "https://i1.sndcdn.com/artworks-000186700926-w0ar73-t500x500.jpg",
    tracks: ["My Birthday", `When I'm Falling`, "Nevermind"],
    tags: ["Pop Punk", "Ivanovo", "NothingPersonal"],
    info: `
      Three songs were waiting for their moment of 2 years.

      nthngpersonal.bandcamp.com/album/nothing-wasted
      yadi.sk/d/2nNCoXbBwG47Q
      vk.com/htkmsc
      vk.com/club14492586
  ...
  },
  {
    ...
    soundloudPlaylistId: "264798475",
    coverUrl: "https://i1.sndcdn.com/artworks-000186694391-co76nh-t500x500.jpg",
    tracks: ["Creator", "Weekend"],
    tags: ["Dance", "Ivanovo", "2am"],
    info: `
      vk.com/club69046948
      soundcloud.com/hotkeymusic/sets/2-a-m-creator-weekend
    `
  },
  {
    band: "2 a.m.",
