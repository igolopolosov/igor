...
import {AnimationCallback, I2DCoordinates, I2DVector} from '../animation/movement2D.interface';
...
export class AnimatedElement {
     ...
     * Configure animation
     */
    public setupAnimation(initialVector: I2DVector, animationCallback: AnimationCallback) {
