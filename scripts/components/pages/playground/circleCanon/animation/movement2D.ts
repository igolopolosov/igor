...
import {AnimationCallback, IAnimationParams, IBounceParams} from './movement2D.interface';
 ...
 */
export const gravity2DMovement: AnimationCallback = (params: IAnimationParams) => {
 ...
 */
export const getBounce2DMovement = (params: IBounceParams): AnimationCallback => {
